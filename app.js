...
const CATEGORIES = {
  ...
  envy: {
    ...
    items: [
      {
        comment: "В КПТ начинают с конкретики — размытое чувство разобрать трудно, а конкретную ситуацию можно.",
      ...
      {
        comment: "КПТ переводит понимание в действие — маленький конкретный шаг снимает напряжение лучше, чем размышления.",
