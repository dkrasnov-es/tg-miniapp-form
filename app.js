    ...
    steps: [
      {
        ...
        questions: [
          ...
          "Что, по моему прогнозу, должны были подумать другие?",
          "Как я пытался не допустить этого?",
          "Могло ли моё защитное поведение само затруднить общение?"
        ]
      },
      {
        ...
        questions: [
          "Что я непосредственно наблюдал, а что додумал?",
          "Кто-то действительно показал, что не хочет со мной разговаривать?",
          "Какие ещё причины могли объяснять отсутствие контакта?",
          "Возможно ли, что группа уже была увлечена своим разговором?",
          "Стал бы я так же строго оценивать другого молчаливого человека?",
          "Какое объяснение будет честным, но не унизительным?"
        ]
      },
      {
      ...
      },
      {
        ...
        questions: [
          ...
          "От какого одного защитного действия я могу отказаться сегодня?"
        ]
      },
      {
        ...
        questions: [
          ...
          "Что люди реально сделали?",
          "Кто-нибудь явно отверг меня?",
          "Ответили ли мне хотя бы нейтрально?",
          "Насколько сбылся прогноз, от 0 до 100%?",
          "Что этот опыт показывает, даже если разговор не стал замечательным?"
        ]
      },
      {
      ...
      },
      {
        ...
        questions: [
          "Три наблюдаемых факта: что произошло без оценок?",
          "Одна вещь, которую я сделал несмотря на тревогу?",
          "Один навык для следующего раза?",
      ...
      },
      {
        ...
        questions: [
          ...
          "Какую последнюю фразу я услышал?",
          "Какую деталь я могу уточнить?",
