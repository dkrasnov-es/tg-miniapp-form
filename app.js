...
const CATEGORIES = {
  procrastination: {
    ...
    describePrompt: "Опишите конкретнее, своими словами: что именно вы откладываете и в какой ситуации?",
    items: [
      {
        comment: "Вопросы про смысл помогают вспомнить, зачем это вообще нужно.",
        question: "Что станет лучше через месяц/год, если я буду это делать регулярно?"
      },
      {
        comment: "Иногда «не хочу» — это не лень, а страх, усталость, неясность или слишком большой объем.",
        question: "Мне не хочется, потому что задача неприятная, слишком большая или непонятная?"
      },
      {
        comment: "Когда задача кажется большой, мозг сопротивляется. Нужно уменьшить входной порог.",
        question: "Что я могу сделать за 2 минуты?"
      },
      {
        comment: "Когда «не хочется», мозг начинает торговаться: «потом», «завтра», «не сейчас». Тут помогают вопросы про честность.",
        question: "Я правда выбираю не делать это или просто избегаю дискомфорта?"
      },
      {
        comment: "Вопросы про идентичность помогают действовать не из настроения, а из образа человека, которым ты хочешь стать.",
        question: "Как бы поступил человек, который серьезно относится к этой цели?"
      },
      {
        comment: "Иногда нужно сделать действие эмоционально дешевле.",
        question: "Как я могу сделать это чуть приятнее?"
      },
      {
        comment: "Когда мотивации нет, лучше использовать не размышления, а запуск.",
        question: "Могу ли я начать, не обещая закончить?"
      }
    ]
  },
  failure: {
    title: "Неудача",
    describePrompt: "Опишите конкретнее, своими словами: какая неудача произошла и в какой ситуации?",
    items: [
      {
        comment: "Вместо вопроса «Что это говорит обо мне?» спроси:",
        question: "Что именно произошло?"
      },
      {
        comment: "Я описываю себя целиком или только своё выступление в этой ситуации?",
        question: "Это утверждение про мою личность целиком или про один конкретный случай?"
      },
      {
        comment: "Ярлыки обычно слишком широкие. У фактов есть границы.",
        question: "В какой именно области у меня не получается?"
      },
      {
        comment: "Это постоянная черта личности или текущий уровень навыка?",
        question: "Это что-то неизменное или то, что можно натренировать?"
      },
      {
        comment: "Вместо того чтобы превращать результат в личность, разбери его на причины.",
        question: "Проблема была в нехватке навыка?"
      },
      {
        comment: "Важно: сбалансированная версия не должна быть фальшиво-позитивной.",
        question: "Какой честный факт без оскорбления?"
      },
      {
        comment: "Ярлыки обычно останавливают действие. Факты создают действие.",
        question: "Что одно я могу улучшить?"
      }
    ]
  }
